...
import { myProfile, getUserProfile, updateUserProfile, updateProfilePic, updateResume, addSkillToUser, deleteSkillFromUser, applyForJob, getAllaplications } from "../controllers/user.js";
