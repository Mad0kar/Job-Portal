...
{/*After user pays on Razorpay popup, this function automatically runs, takes the 3 payment values Razorpay provides, sends them to the backend for 
    verification, and if payment is real it updates the user's subscription, shows a success message, and redirects to the success page — if payment fails it
