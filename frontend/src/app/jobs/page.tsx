...
const JobsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-secondary/30">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          {hasActiveFilters && (
            ...
            {/*To show the title filter that is applied with the button to cancel it*/}
              {title && (
            ...
            {/*To show the location filter that is applied with the button to cancel it*/}
              {location && (
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 text-sm">
                  <MapPin size={14} />
                  {location}
          ...
          {loading ? (
            ...
            <>
            {/*This part of code is to show all job cards */}
              {jobs && jobs.length > 0 ? (               
      ...
      {/*This dialog is for applying the job and location filer  */}
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[500px]">
            ...
            <div className="space-y-5 py-4"> 
                ...
                {/*input space to wrtie job for filter */}
              <div className="space-y-2">
                ...
                {/*input space to write location for filter */}
              <div className="space-y-2">
                <Label
                  htmlFor="location"
                  className="text-sm font-medium flex items-center gap-2"
