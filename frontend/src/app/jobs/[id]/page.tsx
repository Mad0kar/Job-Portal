...
const JobPage = () => {
  ...
  const [value, setValue] = useState(""); // value is the value of status it an be submitted,hired,rejected
              ...
              <Card className="overflow-hidden shadow-lg border-2 mb-6">
                <div className="bg-blue-600 p-8 border-b">
                  <div className="flex items-start justify-between gap-4 flex-wrap">
                    ...
                    {/*if user is jobseeker then show easy apply button if not already applied and show already applied button if aalready applied  */}
              ...
              <div className="space-y-4">
                {filteredApplications.map((e) => (
                  ...
                  {/*show application status */}
                    ...
                    {/*option to view resume and user applicant profile */}
