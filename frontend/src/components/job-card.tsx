...
const JobCard: React.FC<JobCardProps> = ({ job }) => {
  ...
  {/*these few lines handles job applications — it checks if a user already applied to a job when the page loads, and provides a function to apply if they haven't.*/}
  useEffect(() => {
    ...
    <Card className="w-full max-w-[380px] hover:shadow-lg transition-all duration-300 border-2 hover:border-blue-500 group">
      ...
      <CardHeader className="space-y-4 pb-4">
        <div className="flex items-start justify-between gap-3">
            {/*To show job title and job company name */}
      ...
      <CardContent className="flex flex-col gap-3 pt-4 border-t">
        ...
        <div className="flex w-full gap-2">
          ...
          {/*To show applied or easy apply option */}
