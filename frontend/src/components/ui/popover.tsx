...
function PopoverTrigger({ asChild, children, ...props }: any) {
  // When asChild is true, we use Radix's Slot to perfectly merge Base UI's 
  // accessibility props directly onto your custom <button> without wrapping it.
  if (asChild) {
    return (
  ...
  // Default behavior if asChild is not used
  return (
