...
const CarrerGuide = () => {
  ...
  return (
    ...
    {/*Now make a input box wth title "Add skills" and placeholder"e.g., React, Node.js, Python..." and also a button along with it as "Add" after either clicking the Add button or pressing enter, the input box becomes empty and the skills are mentioned at the botton of dialogue box under "Your Skills"*/}                
    ...
    {/*Now inside dialogue box we mention the skills as "Your Skills {Total no. skills}" and you have added a cross mark to unselect them */ }
                  {skills.length > 0 && (
                    <div className="space-y-2">
    ...
    {/*Now add a button to get career guidance */}             
                  <Button
       ...
       {/*Now going to show the response*/}             
                  {/* summary */}
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                        {/*response.jobOptions is an array of jobs coming from the API
                          .map() loops through each job and creates a card for every job
                          job = current job object
                           index = position number (0, 1, 2...) */}
 ...
 {/*This code has two loops nested inside each other. The outer loop goes through each category (like Frontend, Backend). The inner loop goes through each skill inside that category and displays its title, why you should learn it, and how to learn it. So it is basically a loop inside a loop to display a grouped list of skil */}                   
                  ...
                  {/* Learning approch */}
{/*This code displays a Learning Approach section with a title and a list of points. It loops through response.learningApproach.points and shows each point as a bullet item. The special thing here is dangerouslySetInnerHTML which allows the points to contain and render actual HTML tags sent from the server. Optional chaining ?. is used everywhere to prevent crashes if any value is missing. */}
